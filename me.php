...
?> <!doctype html><html class="no-js" lang="en"><head> <?php
	...
	?> </head><body data-barba="wrapper"> <?php include_once "part_head.php" ?> <main data-barba="container" data-barba-namespace="me" class="me"><section class="imuiux middle"><div class="main-text"><h1>Hello, my name is Dwan</h1></div><div class="arrow-big"><a href="#imuiux" class="arrow scrollto"><span>scroll down</span></a></div></section><section id="imuiux" class="imuiux middle"><div class="text"><h1>I'm a UI/UX Designer and Strategist</h1><p>a.k.a. Web Designer on Steroid</p></div><div class="paging"><span>1</span><hr><span>4</span></div></section><section class="about us middle"><div class="text"><h2>Other Then Web Designer</h2><p>I do lots of things in the past, like becoming Macromedia Flash Expert, Database Programmer, Creative Director, Chief Creative Officer, and CIO among others.</p></div><div class="paging"><span>2</span><hr><span>4</span></div></section><section class="know us middle"><div class="text"><h2><a href="./say-hi" class="arrow spring superbig">Send Me a Hi!</a></h2><p>If you happened to know any Indonesian living in Tel Aviv-Yafo, <strong>Mr. Goat wants to meet them</strong>. Also if you want to ask me something or if you want some project leads.</p></div><div class="paging"><span>3</span><hr><span>4</span></div></section><section class="who us middle"><div class="text"><h2>and who is this Mr. Goat you asked?</h2></div><div class="paging"><span>4</span><hr><span>4</span></div></section><section class="mrgoat middle"><div class="text"><div class="h2"><h2 class="h21">this is <b>mr. goat</b></h2></div><div class="h2"><h3 class="h22">he's a vietnamese</h3></div><div class="h2"><h3 class="h23">he likes to travel</h3></div><div class="h2"><h4 class="h24">and here're his instagram posts</h4></div><div class="ig"><a href="https://instagram.com/mrgoatofficial" data-barba-prevent target="BLANK" class="arrow spring superbig"><span>his instagram</span></a></div></div><div class="thumbs"> <?php for ($x = 1; $x <= 26; $x++) { ?> <img class="mrgoat<?php echo $x; ?>" src="/dwaan/img/mrgoat/mrgoat<?php echo $x; ?>.png" width="" height="" alt="Mr. Goat"> <?php } ?> </div></section><section class="igstage middle"><div class="thumbs"> <?php
					$length = 12;
					for ($i = 0; $i < $length; $i++) {
						$data = $obj->data[$i];
