...
<head>
	<?php
	$title = "RePlurk 2022";
	$description = "Unofficial Plurk Year End Recap for 2022";
		...
		<section id="credits" class="middle">
			<div class="text">
				...
				<p class="like likeandsupport">
					<a href="https://www.plurk.com/p/p2nx0u" target="_BLANK"><img src="/dwaan/img/emojis/bow.webp" width="64" height="64" alt="" /> <i>Say Hi! to me in Plurk</i></a>
					<a href="https://www.plurk.com/Premium/gift?plurk_id=1516129518" target="_BLANK"><img src="/dwaan/img/emojis/full_moon.webp" width="64" height="64" alt="" /> <i>Send me a Plurk Coin</i></a>
					<a href="https://www.buymeacoffee.com/dwaan" target="_BLANK"><img src="/dwaan/img/emojis/icecream.webp" width="64" height="64" alt="" /> <i>Buy me an Ice Cream</i></a>
				</p>
				...
				<p class="noaffiliation">You can clone this web app source code from <a href="https://github.com/dwaan/replurk" target="_BLANK">GitHub</a></p>
			</div>
		</section>
