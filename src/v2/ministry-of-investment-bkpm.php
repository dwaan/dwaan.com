...
<head>
    <?php
    $title = "Ministry of Investment/BKPM Website Redesign";
    $description = "A short study case of website redesign for Ministry of Investment/BKPM";
...
<body data-barba="wrapper">
    ...
    <main data-barba="container" data-barba-namespace="detail" class="detail bkpm">
        <img loading="lazy" src="/img/qr/bkpm.svg" width="64" height="64" alt="Dwan - Ministry of Investment/BKPM Website Redesign" class="print qr" hidden />
        ...
        <section id="more" class="middle style-staggered clip snap">
            <div class="text">
                <div class="titles">
            ...
            <div class="thumbs">
                <?php for ($i = 1; $i <= 3; $i++) { ?>
                    <picture class="pic-<?php echo $i ?>">
                        <source media="(min-width: 1024px)" srcset="/img/bkpm/bkpm-<?php echo $i ?>@2x.webp 2x, /img/bkpm/bkpm-<?php echo $i ?>@3x.webp 3x">
                        <img loading="lazy" src="/img/bkpm/bkpm-<?php echo $i ?>.webp" height="200" alt="Ministry of Investment/BKPM - Page <?php echo $i ?> - by Dwan" />
                    </picture>
                <?php } ?>
            </div>
        </section>
        ...
        <section id="the-concept" class="middle style-top--coverflow snap">
            <div class="text">
                ...
                <div class="meta">
                    <img loading="lazy" src="/img/bkpm/bkpm-logo.svg" width="62" height="48" alt="BKPM Logo" />
                    <div>
                        <img loading="lazy" src="/img/bkpm/bkpm-grow.svg" width="24" height="24" alt="BKPM Growth" />
                        Growth
                    </div>
                    <ul class="flat color">
            ...
            <div class="thumbs">
                <?php for ($i = 6; $i <= 8; $i++) { ?>
                    <picture class="pic-<?php echo $i ?>">
                        <source media="(min-width: 1024px) and (min-device-pixel-ratio: 2)" srcset="/img/bkpm/bkpm-<?php echo $i ?>@2x.webp 2x, /img/bkpm/bkpm-<?php echo $i ?>@3x.webp 3x">
                        <img loading="lazy" src="/img/bkpm/bkpm-<?php echo $i ?>.webp" height="150" alt="Ministry of Investment/BKPM - Page <?php echo $i ?> - by Dwan" />
                    </picture>
                <?php } ?>
            </div>
        </section>
        ...
        <section class="middle style-center style-center-small style-picture-parallax snap">
            ...
            <div class="thumbs">
                <?php for ($i = 17; $i <= 19; $i++) { ?>
                    <picture class="pic-<?php echo $i ?>">
                        <source media="(min-width: 1024px) and (min-device-pixel-ratio: 2)" srcset="/img/bkpm/bkpm-<?php echo $i ?>@2x.webp 2x, /img/bkpm/bkpm-<?php echo $i ?>@2x.webp 3x">
                        <img loading="lazy" src="/img/bkpm/bkpm-<?php echo $i ?>.webp" height="150" alt="Ministry of Investment/BKPM - Page <?php echo $i ?> - by Dwan" />
                    </picture>
                <?php } ?>
            </div>
        ...
        <section class="middle style-background clip snap-bottom">
            ...
            <div class="thumbs">
                <img loading="lazy" src="/img/bkpm/guideline.webp" height="768" alt="Ministry of Investment/BKPM Website Redesign - Guideline - by Dwan" />
            </div>
        </section>
        ...
        <div class="links snap-bottom">
            <nav>
                <div class="prototype">
                    ...
                    <a href="https://www.figma.com/proto/PTAR9ug8mQjXEhy2M1E1Mx/BKPM---Large?page-id=0%3A1&node-id=1%3A2&viewport=25%2C55%2C0.02&scaling=scale-down-width&starting-point-node-id=1%3A2&hotspot-hints=0&hide-ui=1" aria-label="Figma Prototype - Ministry of Investment/BKPM - Website Redesign" target="_BLANK"><span>large</span></a>
                    <a href="https://www.figma.com/proto/WUa4QyRqVWdFbvjiBn9C7Q/BKPM---Medium?page-id=0%3A1&node-id=1%3A2&viewport=177%2C25%2C0.02&scaling=contain&starting-point-node-id=1%3A2&hotspot-hints=0&hide-ui=1" aria-label="Figma Prototype - Ministry of Investment/BKPM - Website Redesign" target="_BLANK"><span>medium</span></a>
