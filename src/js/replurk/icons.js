...
var icons = {
	...
	draw: function(title, size = "auto", flat = false) {
		if (flat) {
			return `<img src="https://api.iconify.design/fluent-emoji-high-contrast/${title}.svg?width=${size}&height=${size}&color=%2388888888&box=1" />`
		} else {
			return `<img src="https://api.iconify.design/fluent-emoji/${title}.svg?width=${size}&height=${size}&box=1" />`
		}
	}
}
