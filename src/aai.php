    ...
    <main data-barba="container" data-barba-namespace="detail" class="detail aai">
        ...
        <section id="more" class="middle style-spread style-spread-2 clip snap">
            <div class="text">
                ...
                <p>Asosiasi Antropologi Indonesia (AAI) website was due to redesign. They have a clear idea on how their
                    website should look like and I’m helping them to create it.</p>
            </div>
            <div class="thumbs">
                <?php for ($i=1; $i <= 3; $i++) { ?>
                <picture class="pic-<?php echo $i ?>">
                    <source media="(-webkit-min-device-pixel-ratio: 2.5), (min-resolution: 216dpi)"
                        srcset="/dwaan/img/aai/aai-<?php echo $i ?>@3x.webp">
                    <source media="(-webkit-min-device-pixel-ratio: 1.5), (min-resolution: 144dpi)"
                        srcset="/dwaan/img/aai/aai-<?php echo $i ?>@2x.webp">
                    <img src="/dwaan/img/aai/aai-<?php echo $i ?>.webp" width="" height=""
                        alt="AAI Website Redesign - Page <?php echo $i ?> - by Dwan" />
                </picture>
                <?php } ?>
            </div>
        </section>
        ...
        <section class="middle style-flex snap">
            <div class="style-row">
                <div class="style-column">
                    <div class="meta">
                        <img src="/dwaan/img/logo/aai.svg" width="140" height="48" alt="AAI's Logo" />
                    </div>
                    <div class="text">
                        <h3>Brand Identity</h3>
                        <p>The use non common word “<strong>Kerabat</strong>”, which means "you + family" to refer “you”
                            was a way to make the website sounds like antropolog.</p>
                    </div>
                </div>
                <div class="style-column">
                ...
                <div class="style-column">
                    <div class="meta">
                        <img src="/dwaan/img/aai/slant.svg" width="46" height="32" alt="AAI's Slant Identity" />
                    </div>
                    <div class="text">
                        <small>The slant on the A in the logo was use extensively as decoration and brand
                            identity.</small>
                    </div>
                </div>
            </div>
        ...
        <section class="middle style-background clip snap-bottom">
            ...
            <div class="thumbs">
                <img src="/dwaan/img/aai/guideline.svg" width="" height=""
                    alt="AAI Website Redesign - Guideline - by Dwan" />
            </div>
        </section>
        ...
        <section class="links snap-bottom">
            <nav>
                <div class="prototype">
                    <a href="https://www.figma.com/proto/L4qTK2ufFdy5i0K0TxryVf/AAI---Desktop?page-id=0%3A1&node-id=0%3A1&viewport=229%2C187%2C0.04&scaling=scale-down-width&starting-point-node-id=1%3A2&hotspot-hints=0&hide-ui=1"
                        aria-label="Figma Prototype - AAI - Website Redesign" target="_BLANK" class="title"><span>visit
                            the
                            prototype</span></a>
                    <a href="https://www.figma.com/proto/L4qTK2ufFdy5i0K0TxryVf/AAI---Desktop?page-id=0%3A1&node-id=0%3A1&viewport=229%2C187%2C0.04&scaling=scale-down-width&starting-point-node-id=1%3A2&hotspot-hints=0&hide-ui=1"
                        aria-label="Figma Prototype - AAI - Website Redesign" target="_BLANK"><span>desktop</span></a>
                    <a href="https://www.figma.com/proto/adzmnbh8sUFWV8G9vdB28Q/AAI---Mobile?page-id=0%3A1&node-id=1%3A2&viewport=385%2C26%2C0.06&scaling=contain&starting-point-node-id=1%3A2&hotspot-hints=0&hide-ui=1"
                        aria-label="Figma Prototype - AAI - Website Redesign" target="_BLANK"><span>mobile</span></a>
                </div>
                <div class="continue">
