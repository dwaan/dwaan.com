	...
	<section id="permission" class="middle first snap-bottom">
		<div class="text">
			<form action="" method="GET">
				...
				<ol>
					<li><p>Grant <strong>RePlurk</strong> access to your Plurk timeline <br/><a href="#" id="tokenurl" data-barba-prevent target="_BLANK" rel="opener">Loading...</a></p></li>
	...
	<section id="credits" class="middle">
		<div class="text">
			...
			<p class="like likeandsupport">
				<a href="https://www.plurk.com/p/onlc5m" target="_BLANK"><img src="/dwaan/img/emojis/bow.webp" width="64" height="64" alt="" /> <i>Say Hi! to me in Plurk</i></a>
				<a href="https://www.plurk.com/Premium/gift?plurk_id=1490814922" target="_BLANK"><img src="/dwaan/img/emojis/full_moon.webp" width="64" height="64" alt="" /> <i>Send me a Plurk Coin</i></a>
