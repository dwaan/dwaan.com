...
<body data-barba="wrapper">
	...
	<main data-barba="container" data-barba-namespace="me" class="me">
		...
		<section id="imuiux" class="imuiux middle">
			<div class="text">
				<h2>I'm a UI/UX Designer and Strategist</h2>
				<p>a.k.a. Web Designer on Steroid</p>
				<h3>Before Becoming Web Designer</h3>
				<p>I did lots of things in the past, like becoming Macromedia Flash Expert, Database Programmer, Creative Director, Chief Creative Officer, and CIO among others.</p>
				<h3>Would You like to Send Me a "Hi!"?</h3>
				<p>I hapen to live in in Tel Aviv-Yafo right now. If you happened to know any Indonesian living in Tel Aviv-Yafo, <strong>Mr. Goat wants to meet them</strong>. Other then that, if you wanted to work with me feel free to <a href="./say-hi" class="spring big">say hi</a>.</p>
				<h4>and who is this Mr. Goat you asked?</h4>
			</div>
		</section>

		<section id="startmrgoat" class="mrgoat us middle">
			<div class="text">
				<div class="h2"><h2>This is <b>Mr. Goat</b></h2></div>
				<p>He's a vietnamese, he likes to travel - a lot, and here's some of his instagram posts</p>
			</div>
			<div class="thumbs">
				<img src="/dwaan/img/mrgoat/mrgoat4.png" width="" height="" alt="Mr. Goat" />
			</div>
		</section>

		<div style="display: none;">
			<section class="mrgoat us middle">
				<div class="text">
					<div class="h2"><h3>He's a Vietnamese</h3></div>
				</div>
				<div class="thumbs">
					<img src="/dwaan/img/mrgoat/mrgoat8.png" width="" height="" alt="Mr. Goat" />
				</div>
			</section>

			<section class="mrgoat us middle">
				<div class="text">
					<div class="h2"><h3>He likes to Travel</h3></div>
				</div>
				<div class="thumbs">
					<img src="/dwaan/img/mrgoat/mrgoat12.png" width="" height="" alt="Mr. Goat" />
				</div>
			</section>

			<section id="stopmrgoat" class="mrgoat igintro us middle">
				<div class="text">
					<div class="h2"><h4>and Here's Some of His Instagram Posts</h4></div>
				</div>
				<div class="thumbs">
					<img src="/dwaan/img/mrgoat/mrgoat16.png" width="" height="" alt="Mr. Goat" />
				</div>
				<a href="https://instagram.com/mrgoatofficial" data-barba-prevent target='BLANK' class="arrow spring superbig" class="arrow"><span>his instagram</span></a>
			</section>

			<section class="mrgoat spin middle">
				<div class="thumbs">
					<?php for ($x = 1; $x <= 26; $x++) { ?>
