				...
				<div class="me">
					<div id="firstscene">
						<div class="imuiux block__full">
							<div class="block__middle">
								...
								<img src="/img/roll-eyes-up.png" width="" height="" alt="Dwan rolling his eyes up" />
							</div>
						</div>
					...
					<div class="mrgoat block__full">
						<div class="mrgate block__full">
							...
							<div class="img">
								<?php for ($x = 1; $x <= 26; $x++) { ?>
								<img class="mrgoat<?php echo $x; ?>" src="/img/mrgoat/mrgoat<?php echo $x; ?>.png" width="" height="" alt="Mr. Goat" />
								<?php } ?>
							</div>
						</div>
						<div class="igstage">
					...
					<div class="capabilities block__full">
						...
						<div class="work__list">
							...
							<ul class="block block__clear flat">
								<li><a href="./melon-tiket-apa-saja"><span><img src="/img/ss-tiketapasaja/tiket-apa-saja.jpg" width="" height="" alt="PPATK - E-Learning for Banking Frontliner" /></span><span>Melon - Tiket Apa Saja</span></a></li>
								<li><a href="./ppatk-e-learning-for-bank-frontliner"><span><img src="/img/ss1.jpg" width="" height="" alt="PPATK - E-Learning for Banking Frontliner" /></span><span>PPATK - E-Learning for Banking Frontliner</span></a></li>
