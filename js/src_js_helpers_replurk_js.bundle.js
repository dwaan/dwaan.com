"use strict";
(self["webpackChunkdwaan"] = self["webpackChunkdwaan"] || []).push([["src_js_helpers_replurk_js"],{

/***/ "./src/js/helpers/replurk.js":
/*!***********************************!*\
  !*** ./src/js/helpers/replurk.js ***!
  \***********************************/
...
/* harmony import */ var _helpers_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers/api */ "./src/js/helpers/api.js");
/* harmony import */ var _helpers_scroll__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers/scroll */ "./src/js/helpers/scroll.js");
...
/* harmony import */ var _helpers_animate__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/animate */ "./src/js/helpers/animate.js");
...
/* harmony import */ var _helpers_helper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../helpers/helper */ "./src/js/helpers/helper.js");
...
class span {
    ...
    update(text) {
        (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.animateNumber)(this.el.textContent, text, (text) => {
...
class colors {
    ...
    getRandomColor() {
        var color;
        do {
            this.randomcolors = gsap_all__WEBPACK_IMPORTED_MODULE_6__.gsap.utils.shuffle(this.colors).slice();
    ...
    */
    friends = {
        ...
        find: async function (user_id) {
            ...
            if (this.data && this.data[user_id]) {
                ...
                var result = await _helpers_api__WEBPACK_IMPORTED_MODULE_0__["default"].call("?fetch=APP&url=/Profile/getPublicProfile&user_id=" + user_id);
        ...
        findByUsername: async function (nick_name) {
            ...
            if (user_id) {
                ...
                var result = await _helpers_api__WEBPACK_IMPORTED_MODULE_0__["default"].call("?fetch=APP&url=/Profile/getPublicProfile&nick_name=" + nick_name);
    ...
    statistics = {
        ...
        afterDraw: function (el) {
            var length = (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.reduceMotionFilter)(1);

            if ((0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.hasClass)(el, 'wrap')) {
                var color = new colors();
                var randomcolors = [color.getRandomColor(), color.getRandomColor()]
                var anim = el.querySelector(".anim");

                gsap_all__WEBPACK_IMPORTED_MODULE_6__.gsap.set(anim, {
                    background: 'radial-gradient(at 10% 10%, ' + randomcolors[0] + ' 0%, ' + randomcolors[1] + ' 100%)'
                });

                gsap_all__WEBPACK_IMPORTED_MODULE_6__.gsap.fromTo(anim, {
                    opacity: 0
                }, {
                    opacity: 1,
                    duration: length / 2,
                ...
                var screen = gsap_all__WEBPACK_IMPORTED_MODULE_6__.gsap.matchMedia();
                screen.add("(min-aspect-ratio: 1/1)", () => {
                    _helpers_scroll__WEBPACK_IMPORTED_MODULE_1__["default"].push(tl => {
                        ...
                        return gsap_all__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger.create({
                            trigger: el,
                            start: "0 100%-=100px",
                            end: "0 100%-=100px",
                            animation: tl,
                ...
                _helpers_scroll__WEBPACK_IMPORTED_MODULE_1__["default"].push(function (tl) {
                    if (el.querySelector(".big")) {
                        ...
                        if (number > 0) {
                            ...
                            tl.to(load, {
                                ...
                                duration: duration,
                                onUpdate: () => {
                                    el.querySelector(".big").textContent = (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(load.progress);
                                }
                            }, 0);
                        }
                    }
            ...
            if ((0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.hasClass)(el, 'drawgraph')) {
                _helpers_scroll__WEBPACK_IMPORTED_MODULE_1__["default"].push(tl => {
            ...
            if ((0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.hasClass)(el, 'coins')) {
                _helpers_scroll__WEBPACK_IMPORTED_MODULE_1__["default"].push(tl => {
            ...
            _helpers_scroll__WEBPACK_IMPORTED_MODULE_1__["default"].refresh();
        },
        capture: (el) => {
            ...
            capture.onclick = async () => {
                ...
                imgs.forEach(img => {
                    ...
                    img.localUrl = true;
                    img.setAttribute("src", _helpers_api__WEBPACK_IMPORTED_MODULE_0__["default"].url + "?img=" + img.getAttribute("src"));
                });
                // Load and cache image
                await (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.waitForImg)(imgs, (_, progress) => {
                    capture.innerHTML = "Downloading images... (" + Math.round(progress) + "%)";
                });

                // HTML to Canvas magic
                capture.innerHTML = "Processing...";
                var canvas = await html2canvas__WEBPACK_IMPORTED_MODULE_4___default()(el.querySelector(".anim"), {
        ...
        attach: function (charttitle, node, max) {
            ...
            if (!hidden && !node.attached) {
                ...
                gsap_all__WEBPACK_IMPORTED_MODULE_6__.gsap.set(node.el, {
                    top: maxTop + "%",
                    opacity: 0,
                    zIndex: 0,
                });
            ...
            if (!hidden || !node.hidden) {
                ...
                gsap_all__WEBPACK_IMPORTED_MODULE_6__.gsap.killTweensOf(node.el);
                gsap_all__WEBPACK_IMPORTED_MODULE_6__.gsap.to(node.el, {
                    top: currentTop + "%",
                    opacity: opacity,
                    zIndex: zIndex,
                    duration: length / 2,
        ...
        drawAll: async function (plurks) {
            ...
            this.draw('spansmall recievereplurk', this.replurker_count, 'I received <i>📢 ' + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(this.replurker_count, 'replurk') + '</i>');
            this.parent.most.replurk.draw(plurks);

            this.parent.most.favorite.draw(plurks);
            this.draw('spansmall recievelove', this.favourite_count, 'I recieved <i>❤️ ' + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(this.favourite_count, 'love') + '</i>');

            this.draw('spansmall privateplurk', this.private_count, 'I posted <i>💋 ' + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(this.private_count, 'private plurk') + '</i>');
            this.draw('spansmall whisper', this.whispers_count, 'I posted <i>🤫 ' + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(this.whispers_count, 'whisper') + '</i>');
            this.draw('spansmall porn', this.porn_count, 'I posted <i>🤤 ' + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(this.porn_count, 'adult plurk') + '</i>');

            this.draw('span2 responsecount', this.plurks_count + " &rarr; " + this.response_count, 'I received <i>💬 ' + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(this.response_count, 'response') + '</i> from <i>' + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(this.plurks_count, 'plurk') + '</i>');
            this.draw('spansmall center coins', this.coins_count, 'I recieved <i>🪙 ' + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(this.coins_count, 'coin') + '</i>');
    ...
    most = {
        ...
        links: {
            ...
            drawLinks: function () {
                ...
                if (this.links.length > 0) this.parent.statistics.drawDiv('spansmall sharedlinks', "<div class='title'>I shared <i>🔗 " + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(this.links.length, 'link') + '</i> and this is the most popular one</div>' + result);
            },
            drawPics: function () {
                var max = 1;
                var index = 0;
                ...
                while (index < this.data.length && max > 0) {
                    if (this.data[index].pics.length > 0) {
                        ...
                        result += '<div class="box"><div class="image" style="background-image: url(' + _helpers_api__WEBPACK_IMPORTED_MODULE_0__["default"].url + "?img=" + pics.url + ')"></div><div class="post">' + this.data[index].content + '<div class="meta"><span class="response">💬 ' + pics.response + '</span><span class="replurk">📢 ' + pics.replurk + '</span><span class="loved">❤️ ' + pics.loved + '</span>' + url + '</div></div></div>';
                        max--;
                    }
                    index++;
                }

                if (this.pics.length > 0) this.parent.statistics.draw('spansmall sharedpictures', this.pics.length, 'I shared <i>🖼 ' + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(this.pics.length, 'image') + '</i>');
        ...
        types: {
            ...
            draw: function () {
                if (this.chars > 0) this.parent.statistics.draw('span2 mediumnumber', this.chars, 'I typed more than  <i>' + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.pluralinwords)(this.chars, 'character') + '</i>, around <i>' + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.pluralinwords)(this.words, 'word') + '</i> this year');
            }
        },
        responses: {
            parent: this,
            ...
            draw: function (data) {
                ...
                for (var index in data) {
                    ...
                    if (value.owner_id == this.parent.me.id && value.plurk_type != 3 && value.response_count > 0) {
                        this.parent.statistics.drawPost('postcontent span2 mostresponded', value.plurk_id, '<i>💬 Most Responded</i> ' + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.datediff)(value.posted), value.content, value.response_count);
                        return;
                    }
                }
            }
            ...
            draw: function (data) {
                ...
                for (var index in data) {
                    ...
                    if (value.owner_id == this.parent.me.id && value.plurk_type != 3 && value.replurkers_count > 0) {
                        this.parent.statistics.drawPost('postcontent span2 mostreplurked', value.plurk_id, '<i>📢 Most Replurked</i> ' + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.datediff)(value.posted), value.content, value.replurkers_count);
                        return;
                    }
                }
            }
            ...
            draw: function (data) {
                ...
                for (var index in data) {
                    ...
                    if (value.owner_id == this.parent.me.id && value.plurk_type != 3 && value.favorite_count > 0) {
                        this.parent.statistics.drawPost('postcontent span2 mostfavorited', value.plurk_id, '<i>❤️ Most Loved</i> ' + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.datediff)(value.posted), value.content, value.favorite_count);
                        return;
                    }
                }
            }
    ...
    inactive = {
        draw: (data, year) => {
            ...
            this.statistics.drawPost('postcontent span2 inactivemore', data.plurk_id, '<i>My last Plurk</i> ' + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.datediff)(data.posted), data.content, data.response_count);
        },
        empty: () => {
    ...
    loading = {
        ...
        draw: function (item) {
            return new Promise(resolve => {
                ...
                gsap_all__WEBPACK_IMPORTED_MODULE_6__.gsap.to(load, {
        ...
        forcedone: async function () {
            ...
            return new Promise(resolve => {
                ...
                if (this.isComplete()) {
                    ...
                    this.clean = false;
                    gsap_all__WEBPACK_IMPORTED_MODULE_6__.gsap.to(el, {
                        opacity: 0,
                        width: 0,
                        height: 0,
                        padding: 0,
    ...
    scrollAnimate = {
        ...
        statistics: () => {
            ...
            _helpers_scroll__WEBPACK_IMPORTED_MODULE_1__["default"].push(tl => this.scrollAnimate.credits(tl), tl => gsap_all__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger.create({
        ...
        menu: () => {
            ...
            _helpers_scroll__WEBPACK_IMPORTED_MODULE_1__["default"].push(tl => tl, tl => {
                return gsap_all__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger.create({
                    trigger: 'main',
                    start: "0 0",
                    end: "100% 0",
                    ...
                    onUpdate: update => {
                        ...
                        if (update.direction > 0) {
                            gsap_all__WEBPACK_IMPORTED_MODULE_6__.gsap.killTweensOf((0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__._qAll)(el2));
                            gsap_all__WEBPACK_IMPORTED_MODULE_6__.gsap.to((0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__._qAll)(el1), { y: -100, opacity: 0 });
                            gsap_all__WEBPACK_IMPORTED_MODULE_6__.gsap.to((0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__._qAll)('.footer > *'), { y: 100, opacity: 0 });
                        } else {
                            gsap_all__WEBPACK_IMPORTED_MODULE_6__.gsap.to((0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__._qAll)(el2), { y: 0, opacity: 1 });
                        }
                    }
                });
            });
    ...
    getSetStateColor(state) {
        if (typeof (state) == "object" && state.length >= 1) {
            if (state.length == 1) {
                _helpers_darkmode__WEBPACK_IMPORTED_MODULE_2__["default"].browserColorDark = state[0];
                _helpers_darkmode__WEBPACK_IMPORTED_MODULE_2__["default"].browserColorLight = state[0];
            } else {
                _helpers_darkmode__WEBPACK_IMPORTED_MODULE_2__["default"].browserColorDark = state[1];
                _helpers_darkmode__WEBPACK_IMPORTED_MODULE_2__["default"].browserColorLight = state[0];
            }
        } else if (state == "green") {
            _helpers_darkmode__WEBPACK_IMPORTED_MODULE_2__["default"].browserColorDark = "#0d4f03";
            _helpers_darkmode__WEBPACK_IMPORTED_MODULE_2__["default"].browserColorLight = "#60e670";
        } else if (state == "yellow") {
            _helpers_darkmode__WEBPACK_IMPORTED_MODULE_2__["default"].browserColorDark = "#705f02";
            _helpers_darkmode__WEBPACK_IMPORTED_MODULE_2__["default"].browserColorLight = "#FFD700";
        } else {
            _helpers_darkmode__WEBPACK_IMPORTED_MODULE_2__["default"].browserColorDark = "#000000";
            _helpers_darkmode__WEBPACK_IMPORTED_MODULE_2__["default"].browserColorLight = "#FFFFFF";
        }

        return [_helpers_darkmode__WEBPACK_IMPORTED_MODULE_2__["default"].browserColorLight, _helpers_darkmode__WEBPACK_IMPORTED_MODULE_2__["default"].browserColorDark];
    }
    browserColor(state, duration, ease) {
        this.getSetStateColor(state);
        _helpers_darkmode__WEBPACK_IMPORTED_MODULE_2__["default"].setDarkMode(duration, ease);
    }
    ...
    showLoginPage(tl) {
        ...
        tl.fromTo(next.querySelectorAll("#permission .bgtext *"), {
            ...
            ease: "power3.out",
            onComplete: () => {
                gsap_all__WEBPACK_IMPORTED_MODULE_6__.gsap.set(next.querySelectorAll("#permission"), {
                    position: "",
                    top: ""
                });
            }
    ...
    hideStatisticPages() {
        return new Promise(async resolve => {
            ...
            await _helpers_animate__WEBPACK_IMPORTED_MODULE_3__["default"].top(next);
            ...
            tl.fromTo(next.querySelectorAll("#hello"), {
                ...
                ease: "power3.in",
                onComplete: () => {
                    gsap_all__WEBPACK_IMPORTED_MODULE_6__.gsap.set(next.querySelectorAll(".grant"), { display: "none" });
                    resolve();
                }
            }, length / 2);
        });
    ...
    message(message, quick) {
        ...
        if (quick) {
            ...
            gsap_all__WEBPACK_IMPORTED_MODULE_6__.gsap.to(loginmessage, {
                opacity: 0,
                onComplete: function () {
                    loginmessage.innerHTML = message;
                    gsap_all__WEBPACK_IMPORTED_MODULE_6__.gsap.to(loginmessage, {
    ...
    async requestLogout() {
        ...
        _helpers_api__WEBPACK_IMPORTED_MODULE_0__["default"].abort();

        // Hide statistic pages
        await this.hideStatisticPages(tl);

        // Logout
        await _helpers_api__WEBPACK_IMPORTED_MODULE_0__["default"].call("?fetch=logout");
        this.statistics.clear();
        _helpers_api__WEBPACK_IMPORTED_MODULE_0__["default"].clear();
        this.login();
    ...
    async requestToken(text) {
        ...
        _helpers_api__WEBPACK_IMPORTED_MODULE_0__["default"].call("?request=token").then(data => {
            if (text) {
                message(text);
            } else {
                tokenlink.textContent = "Grant Access";
                tokenlink.setAttribute("href", _helpers_api__WEBPACK_IMPORTED_MODULE_0__["default"].url + "?redirect=" + data.message.url);
            }
        }, () => {
    ...
    async displayPlurkerData() {
        ...
        if (plurker.anniversary.years && plurker.anniversary.days) {
            this.statistics.draw('spansmall center posted', Math.round(plurker.plurks_count / days), "I posted around <i>💬 " + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(Math.round(plurker.plurks_count / days), "plurk") + " per day</i>");

            // Responses
            var oneday = 16;
            if (responses <= oneday) extra = "That's almost 1 response every <i>" + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(Math.round(oneday / responses), "hour") + '</i>';
            else extra = "That's almost 1 response every <i>" + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(Math.round(oneday * 60 / responses), "minute") + '</i>';
            this.statistics.draw('span2 center responded', responses, "I responded around <i>💬 " + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(responses, "time") + "</i> per day. " + extra + " when I'm not asleep");

            var join = new Date(plurker.join_date)
            this.statistics.draw('spansmall center anniversary', "<strong><i>" + _helpers_helper__WEBPACK_IMPORTED_MODULE_5__.monthNames[join.getMonth()] + "</i> <i>" + join.getFullYear() + "</i></strong> <em>" + join.getDate() + "</em>", "I joined Plurk <i>" + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(plurker.anniversary.years, "year") + "</i> and <i>" + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(plurker.anniversary.days, "day") + "</i> ago");
            this.statistics.draw('spansmall center badges', "9", "I have <i>🛡 " + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(plurker.badges.length, "badge") + "</i> right now");
        } else {
            this.statistics.draw('', '-', "There is no data in my timeline");
            this.statistics.draw('', plurker.badges.length, "But at least I have <i>" + (0,_helpers_helper__WEBPACK_IMPORTED_MODULE_5__.plural)(plurker.badges.length, "badge") + "</i> right now");
        }
        ...
        _helpers_scroll__WEBPACK_IMPORTED_MODULE_1__["default"].push(tl => {
            ...
            return tl;
        }, tl => gsap_all__WEBPACK_IMPORTED_MODULE_7__.ScrollTrigger.create({
    ...
    async displayStatistics() {
        ...
        var getTimeline = async (offset) => {
            ...
            var data = await _helpers_api__WEBPACK_IMPORTED_MODULE_0__["default"].call("?fetch=plurk&filter=my" + offset, 1);
            if (data.success) {
                ...
                if (data.message.plurks.length > 0) {
                    ...
                    if (lastposted >= this.endDate) {
                        this.loading.update("Data from " + _helpers_helper__WEBPACK_IMPORTED_MODULE_5__.monthNames[lastposted.getMonth()] + " " + lastposted.getFullYear(), this.fulldays - Math.floor((lastposted - this.endDate) / this.days));
    ...
    async displayExtendedStatistics() {
        ...
        for (var plurk of this.plurks) {
            ...
            this.loading.update("Data from " + _helpers_helper__WEBPACK_IMPORTED_MODULE_5__.monthNames[date.getMonth()] + " " + date.getFullYear());
            ...
            if (plurk.response_count > 0 && (plurk.responded || plurk.owner_id == this.me.id)) {
                var result = await _helpers_api__WEBPACK_IMPORTED_MODULE_0__["default"].call("?fetch=response&plurk_ids=" + plurk.plurk_id);
    ...
    async login(clear) {
        ...
        _helpers_scroll__WEBPACK_IMPORTED_MODULE_1__["default"].destroy();
        ...
        var data = await _helpers_api__WEBPACK_IMPORTED_MODULE_0__["default"].call("?");
        if (data.success) {
        ...
        // Snap
        next.querySelectorAll("section.snap").forEach(el => _helpers_scroll__WEBPACK_IMPORTED_MODULE_1__["default"].snap(el));
        next.querySelectorAll("section.snap-bottom").forEach(el => _helpers_scroll__WEBPACK_IMPORTED_MODULE_1__["default"].snap(el, "bottom"));
    }
    ...
    run(el) {
        return new Promise(resolve => {
            ...
            // Run the login
            gsap_all__WEBPACK_IMPORTED_MODULE_6__.gsap.fromTo(this.next.querySelectorAll('#credits'), {
                opacity: 0
            }, {
                opacity: 1,
                duration: length,
...
/* harmony default export */ __webpack_exports__["default"] = (replurk);

/***/ })

}]);
//# sourceMappingURL=src_js_helpers_replurk_js.bundle.js.map